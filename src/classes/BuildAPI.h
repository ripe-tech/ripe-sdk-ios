...
/**
 Retrieves the bundle of part, materials and colors translations of the owner's current model and locale. To retrieve the bundle of a specific model the method `-[BuildAPI getLocaleModel:callback:]` should be used.
