...
/**
 Converts a size value from the native scale to the corresponding value in the specified scale. The available scales, genders and sizes can be obtained with the method `-[SizeAPI getSizes:]`
...
/**
 Converts multiple size values from the native scale to the corresponding values in the specified scales. The available scales, genders and sizes can be obtained with the method `-[SizeAPI getSizes:]`
...
/**
 Converts a size value in the specified scale to the corresponding native size. The available scales, genders and sizes can be obtained with the method `-[SizeAPI getSizes:]`
...
/**
 Converts multiple size values to the corresponding native size. The available scales, genders and sizes can be obtained with the method `-[SizeAPI getSizes:]`
