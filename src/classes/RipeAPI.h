...
/**
 Retrieves the price for the current customization. This operation is asynchronous and the provided callback will be called with the result. To retrieve the price of a specific customization the method `-[RipeAPI getPrice:callback:]` should be used.
